...
export default function DashboardOverview() {
    const stats = [
        ...
        { name: "Pending Tasks", value: "5", icon: Clock, color: "text-orange-400" },
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {stats.map((stat, i) => (
                    <motion.div
                        ...
                        className="bg-secondary/20 border border-white/5 rounded-3xl p-6 relative overflow-hidden group shadow-lg"
                    >
                        ...
                        <h3 className="text-4xl font-heading font-bold text-white mb-1 relative z-10">{stat.value}</h3>
            ...
            <motion.h2
                ...
                className="text-xl font-bold font-heading text-white mt-12 mb-6"
            >
                Recent Activity
            </motion.h2>

            <div className="bg-secondary/20 border border-white/5 rounded-3xl overflow-hidden shadow-lg">
                <div className="divide-y divide-white/5">
                    {[
                        ...
                        <motion.div
                            ...
                            className="p-6 md:px-8 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-white/5 transition-colors cursor-pointer group"
                        >
                            <div className="flex items-start sm:items-center space-x-4 mb-4 sm:mb-0">
                                ...
                                <div>
                                    <h4 className="text-white font-medium group-hover:text-accent transition-colors">{activity.title}</h4>
